...
| `main` | Public README, report, notebook, and evaluator-visible mirror | Not run as an experiment (publication surface) | Presentation-only mirror | presentation only |
