...
- Missing: `images/blocked_asset_matrix.png`
- Missing: `images/correction_claim3.png`
- Missing: `images/headline_claim6.png`
- Missing: `images/mechanism_claim1.png`
- Failure: claim-6: cannot locate 'Limitation'
- Failure: live score and forecast are not clearly distinguished
